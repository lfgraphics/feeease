      ...
      <CardContent className="space-y-6">
        ...
        <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="services">
                <AccordionTrigger>External Services (Gmail & Cloudinary)</AccordionTrigger>
                <AccordionContent className="space-y-4 pt-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
        ...
        <Dialog open={showEnvModal} onOpenChange={setShowEnvModal}>
            <DialogContent className="max-w-3xl">
                ...
                <div className="relative mt-4">
                    <pre className="bg-slate-950 text-slate-50 p-4 rounded-lg overflow-x-auto max-h-[400px] text-xs font-mono">
                        {generatedEnv}
                    </pre>
                    <Button
                        size="icon"
