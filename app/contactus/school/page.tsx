...
import SchoolQueryForm from "@/components/SchoolQueryForm";
      ...
      <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="bg-primary text-primary-foreground py-20 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Existing School Support</h1>
            <p className="text-xl text-primary-foreground/90 max-w-2xl mx-auto">
              If your school is already registered, search for it below and send us your query.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 pb-20 relative z-20">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            {/* Contact Info Column (reuse from original page) */}
